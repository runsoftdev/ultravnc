...
// Constants
const UINT RFB_SCREEN_UPDATE = RegisterWindowMessage("RunRemote.Update.DrawRect");
const UINT RFB_COPYRECT_UPDATE = RegisterWindowMessage("RunRemote.Update.CopyRect");
const UINT RFB_MOUSE_UPDATE = RegisterWindowMessage("RunRemote.Update.Mouse");
const char szDesktopSink[] = "RunRemote desktop sink";
...
////////////////////////////////////////////////
	...
	DrawText(m_hmemdc, "UVNC experimental server 1.2.1.1 pre-connect window \n", strlen("UVNC experimental server 1.2.1.1 pre-connect window \n"), &rect, DT_CENTER);
