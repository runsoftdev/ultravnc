...
extern bool G_1111;
// Constants
const UINT MENU_ADD_CLIENT_MSG_INIT = RegisterWindowMessage("RunRemote.AddClient.Message.Init");
const UINT MENU_ADD_CLIENT_MSG = RegisterWindowMessage("RunRemote.AddClient.Message");
const UINT MENU_AUTO_RECONNECT_MSG = RegisterWindowMessage("RunRemote.AddAutoClient.Message");
const UINT MENU_STOP_RECONNECT_MSG = RegisterWindowMessage("RunRemote.AddStopClient.Message");
const UINT MENU_STOP_ALL_RECONNECT_MSG = RegisterWindowMessage("RunRemote.AddStopAllClient.Message");
const UINT MENU_REPEATER_ID_MSG = RegisterWindowMessage("RunRemote.AddRepeaterID.Message");
...
const UINT MENU_TRAYICON_BALLOON_MSG = RegisterWindowMessage("RunRemote.TrayIconBalloon2.Message");
