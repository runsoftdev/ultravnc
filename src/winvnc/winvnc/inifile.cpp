...
IniFile::ReadPassword(char *value,int valuesize)
{
	...
	//vnclog.Print(LL_INTERR, VNCLOG("%s \n"),myInifilePasswd);
	GetPrivateProfileStruct("RunRemote","passwd",value,8,myInifile);
}

void //PGM
IniFile::ReadPassword2(char *value,int valuesize) //PGM
{ //PGM
	GetPrivateProfileStruct("RunRemote","passwd2",value,8,myInifile); //PGM
} //PGM
...
IniFile::WritePassword(char *value)
{
		...
		//vnclog.Print(LL_INTERR, VNCLOG("%s \n"),myInifile);
		return (FALSE != WritePrivateProfileStruct("RunRemote","passwd", value,8,myInifile));
}

bool //PGM
IniFile::WritePassword2(char *value) //PGM
{ //PGM
		return (FALSE != WritePrivateProfileStruct("RunRemote","passwd2", value,8,myInifile)); //PGM
} //PGM
